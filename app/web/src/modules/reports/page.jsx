  ...
  return [
    {
      ...
      columns: [
        { key: 'fecha', label: 'Fecha', pdfLabel: 'Fecha' },
        { key: 'consecutivo', label: 'Consecutivo', pdfLabel: 'Doc' },
        { key: 'cliente', label: 'Cliente', pdfLabel: 'Cliente' },
        { key: 'usuario', label: 'Usuario', pdfLabel: 'Usuario' },
        { key: 'deposito', label: 'Deposito', pdfLabel: 'Bodega' },
        { key: 'ciudad', label: 'Ciudad' },
        { key: 'zona', label: 'Zona' },
        { key: 'estacion', label: 'Estacion', pdfLabel: 'Est.' },
        { key: 'operacion', label: 'Operacion', pdfLabel: 'Oper.' },
        ...
        { key: 'porcentaje', label: '% Utilidad', pdfLabel: '% Util.' },
      ],
