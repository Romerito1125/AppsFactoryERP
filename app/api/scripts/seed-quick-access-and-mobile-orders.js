...
const quickAccessProfiles = [
  {
    ...
    username: 'santiago.admin@appsfactory.local',
    password: 'Admin123*',
    role: 'ADMIN',
  },
  {
    ...
    lastName: 'Cajero',
    phone: '3009000002',
    address: 'Caja principal punto centro',
    clientType: ClientType.MINORISTA,
    username: 'laura.cajero@appsfactory.local',
    password: 'Cajero123*',
    role: 'CAJERO',
  },
  {
    ...
    clientType: ClientType.MINORISTA,
    username: 'valentina.ventas@appsfactory.local',
    password: 'Ventas123*',
    role: 'VENDEDOR',
  },
  {
  ...
  {
    identification: '990000005',
    firstName: 'Camila',
    lastName: 'Conta',
    phone: '3009000005',
    address: 'Area financiera',
    clientType: ClientType.MINORISTA,
    username: 'camila.conta@appsfactory.local',
    password: 'Conta123*',
    role: 'CONTADOR',
  },
  {
    identification: '990000006',
    firstName: 'Nicolas',
    lastName: 'Ventas',
    phone: '3009000006',
    address: 'Zona comercial norte',
    clientType: ClientType.MINORISTA,
    username: 'nicolas.ventas@appsfactory.local',
    password: 'Ventas456*',
    role: 'VENDEDOR',
  },
  {
    identification: '990000007',
    firstName: 'Paula',
    lastName: 'Cajero',
    phone: '3009000007',
    address: 'Caja auxiliar sede sur',
    clientType: ClientType.MINORISTA,
    username: 'paula.cajero@appsfactory.local',
    password: 'Caja456*',
    role: 'CAJERO',
  },
  {
    identification: '990000008',
    firstName: 'Sergio',
    lastName: 'Bodega',
    phone: '3009000008',
    address: 'Cuarto frio y picking ecommerce',
    clientType: ClientType.MINORISTA,
    username: 'sergio.bodega@appsfactory.local',
    password: 'Bodega456*',
    role: 'BODEGA',
  },
]
...
async function main() {
  ...
  console.log(
    JSON.stringify(
      {
        quickAccessUsers: users.map((user) => ({
          ...user,
          password: quickAccessProfiles.find((item) => item.username === user.username)?.password ?? null,
        })),
        appOrders,
        deliveries,
      },
